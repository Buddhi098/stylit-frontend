...
import s11 from "../../assets/images/women_page/s11.png";
import s12 from "../../assets/images/women_page/s12.png";
...
const Section2 = () => {
  ...
  const handleNavigations = (id) => {
    window.scrollTo(0, 0);
    navigate(`/public/dress/women/${id}`)
   }
  ...
  return (
    <Box sx={{ padding: "30px 90px", marginTop: "30px", marginBottom: "16px" }}>
      ...
      <Box sx={{ mt: 4, display: "flex", justifyContent: "flex-start" }}>
        ...
        >
          <Typography variant="body2_alata" padding="5px 10px">
            See More
          </Typography>
        </Button>
      </Box>
