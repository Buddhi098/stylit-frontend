  ...
  const filteredData = tableData.filter((row) => {
    ...
    return filters.every((filter, index) => {
      ...
      if (filteridArray[index] === "deliveryDate") {
        ...
        if (filter === "Within This Month") {
          return new Date(value) >= startOfMonth && new Date(value) <= currentDate;
        } else if (filter === "Within This Year") {
          return new Date(value) >= startOfYear && new Date(value) <= currentDate;
        }
      }
