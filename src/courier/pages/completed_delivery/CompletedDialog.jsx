...
const DeliveryDialog = ({ open, handleClose, selectedRow }) => {
  return (
          ...
          <Box display="flex" alignItems="center">
            {selectedRow && (
              <>
                ...
                <Chip label="Completed" color="success" sx={{textTransform: 'uppercase',fontWeight: 'bold',fontSize:'0.7rem',height:"26px",ml: 4}}/>
              </>
            )}
          </Box>
