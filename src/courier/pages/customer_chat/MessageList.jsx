                ...
                return (
                    <ListItem 
                        ...
                        sx={{ 
                            ...
                            bgcolor: chat.id === selectedChatId ? 'rgba(192, 168, 136, 0.4)' : (unreadCount > 0 ? '#f0f7ff' : 'transparent'),
                            '&:hover': {
                                backgroundColor: chat.id === selectedChatId ? 'rgba(192, 168, 136, 0.4)' : theme => theme.palette.action.hover,
                            }
                        }}
                    >
                        <ListItemAvatar>
