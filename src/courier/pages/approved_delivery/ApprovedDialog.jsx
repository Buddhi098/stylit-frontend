...
const ApprovedDialog = ({ open, handleClose, selectedRow }) => {
  return (
          ...
          <Box display="flex" alignItems="center">
            {selectedRow && (
              <>
                ...
                <Chip label="Approved" sx={{backgroundColor:"#2e7d32",
                color:"#ffffff",textTransform: 'uppercase',fontWeight: 'bold',fontSize:'0.7rem',height:"26px",ml: 4}}/>
              </>
            )}
          </Box>
            ...
            <Box flex={1} ml={1}>
              ...
              {selectedRow && (
                <>
                  ...
                  <Grid container spacing={1} ml={3} mt={0.25}>
                    <Grid item xs={3}><Typography variant="body2"><strong>Delivered Date</strong></Typography></Grid>
