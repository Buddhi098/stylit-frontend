...
import { headCellsAcceptedPayments, headCellsRejectedPayments, RejectedPayments } from "./TableConfig";
...
export default function TableComponent({ rows }) {
  ...
  const getHeadCells = () => {
    return tab === 0 ? headCellsAcceptedPayments : headCellsRejectedPayments;
  };
    ...
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        <Tabs value={tab} onChange={handleTabChange}
          ...
          <Tab label="Accepted Payments" />
          <Tab label="Rejected Payments" />
        </Tabs>
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        <TableRow hover tabIndex={-1} key={row.id} onClick={() => handleRowClick(row)}>
                          ...
                          <TableCell align="right">{row.requiredDate}</TableCell>
                          <TableCell align="right">{row.acceptDate}</TableCell>
