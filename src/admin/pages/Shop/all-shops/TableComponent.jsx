...
export default function TableComponent({ rows }) {
  ...
  const updateStatus = async (event , status , id) => {
    ...
    try{
      if(status == "active"){
        const response = await WebApi.post(`/admin/user/changeStatus`, {id: id , status:"disable"});
        console.log("Response", response);
        window.location.reload();
      }else{
        const response = await WebApi.post(`/admin/user/changeStatus`, {id: id , status:"active"});
        console.log("Response", response);
        window.location.reload();
      }
    }catch(error){
