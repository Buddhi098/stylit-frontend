const messages = [
    ...
    },
    {
        ...
        name: 'Thresilma',
        avatar: 'path_to_avatar.jpg',
        lastMessage: "Your order is expected to arrive by next week.",
        time: '2024-07-26T16:15:00',
        unread: true,
        unreadCount: 2,
        messages: [
            { text: "I want to know where's My order is...", sender: 'customer', time: '2024-07-23T16:00:00' },
            { text: "Your order has been shipped and should arrive soon.", sender: 'shop', time: '2024-07-23T16:05:00' },
            { text: "Can you provide an estimated delivery date?", sender: 'customer', time: '2024-07-23T16:10:00' },
            { text: "We expect it to arrive by next week.", sender: 'shop', time: '2024-07-23T16:15:00' },
            { text: "Thanks for the update!", sender: 'customer', time: '2024-07-23T16:20:00' },
            { text: "Is there any chance it could arrive earlier?", sender: 'customer', time: '2024-07-23T16:25:00' } // Unread messages
        ]
    },
    {
        id: 7,
