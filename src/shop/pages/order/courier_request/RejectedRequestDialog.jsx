...
import SelectCourierDialog from './SelectCourierDialog'; // Import your SelectCourierDialog component

const RejectedRequestDialog = ({ open, handleClose, selectedRow }) => {
  ...
  return (
    <>
            ...
            <Box display="flex" alignItems="center">
              {selectedRow && (
                <>
                  ...
                  <Chip label="Rejected" color="error" sx={{ textTransform: 'uppercase', fontWeight: 'bold', fontSize: '0.7rem', height: "26px", ml: 4 }} />
                </>
              )}
            </Box>
      ...
      {/* Render SelectCourierDialog */}
      <SelectCourierDialog open={courierDialogOpen} handleClose={handleCloseCourierDialog} />
    </>
  );
};
