...
import { filterOptions, tableData, headCellsAllRequests, headCellsRejectedRequests, rejectedRequests } from "./TableConfig";
...
const DataTable = () => {
  ...
  const getHeadCells = () => tab === 0 ? headCellsAllRequests : headCellsRejectedRequests;
  const getData = () => tab === 0 ? tableData : rejectedRequests;
