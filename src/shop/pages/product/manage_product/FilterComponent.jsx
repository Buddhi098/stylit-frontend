  ...
  return (
    ...
    >
      ...
      >
        ...
        <Grid item md={2}>
          ...
          >
            <FilterAltOutlinedIcon
              sx={{ fontSize: "20px", marginRight: "3px", color: "#C0A888" }}
            />
            <Typography variant="h6" sx={{color: "#C0A888"}}>Filter</Typography>
          </ToggleButton>
        </Grid>
        ...
        >
          <Button variant="contained" startIcon={<AddIcon />} sx={{backgroundColor: "#C0A888"}} onClick={() => navigate('/shop/add_new_product')}>
            Add New Products
          </Button>
        </Grid>
      </Grid>
